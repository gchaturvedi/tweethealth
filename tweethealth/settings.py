...
DATABASES = {
    'default': {
        ...
        'NAME': '/Users/gchaturvedi/Playground/djangoproj/test.db',                      # Or path to database file if using sqlite3.
...
ROOT_URLCONF = 'tweethealth.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'tweethealth.wsgi.application'
